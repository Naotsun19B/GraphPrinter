...
namespace GraphPrinter
{
	...
	public:
		// Constructor.
		FGenericGraphPrinter(UPrintGraphOptions* InPrintOptions, URestoreWidgetOptions* InRestoreOptions)
			: Super(InPrintOptions, InRestoreOptions)
...
#else
			if (Widget->GetNumberOfSelectedNodes() == 0)
			{
				return false;
			}
#endif
